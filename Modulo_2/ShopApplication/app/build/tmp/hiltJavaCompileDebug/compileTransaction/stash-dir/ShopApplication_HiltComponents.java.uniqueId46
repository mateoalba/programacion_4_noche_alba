...
import com.shopapp.di.NetworkModule;
import com.shopapp.di.RepositoryModule;
...
public final class ShopApplication_HiltComponents {
  private ShopApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements ShopApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          CategoriesAdminViewModel_HiltModules.KeyModule.class,
          ...
          OrdersAdminViewModel_HiltModules.KeyModule.class,
          OrdersViewModel_HiltModules.KeyModule.class,
          ProductDetailViewModel_HiltModules.KeyModule.class,
          ProductImageViewModel_HiltModules.KeyModule.class,
          ProductsAdminViewModel_HiltModules.KeyModule.class,
          ProfileViewModel_HiltModules.KeyModule.class,
          ResetPasswordConfirmViewModel_HiltModules.KeyModule.class,
          SendNotificationViewModel_HiltModules.KeyModule.class,
          ActivityCBuilderModule.class,
          ViewModelCBuilderModule.class,
          UsersAdminViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          CategoriesAdminViewModel_HiltModules.BindsModule.class,
          ...
          OrdersAdminViewModel_HiltModules.BindsModule.class,
          OrdersViewModel_HiltModules.BindsModule.class,
          ProductDetailViewModel_HiltModules.BindsModule.class,
          ProductImageViewModel_HiltModules.BindsModule.class,
          ProductsAdminViewModel_HiltModules.BindsModule.class,
          ProfileViewModel_HiltModules.BindsModule.class,
          ResetPasswordConfirmViewModel_HiltModules.BindsModule.class,
          SendNotificationViewModel_HiltModules.BindsModule.class,
          UsersAdminViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
