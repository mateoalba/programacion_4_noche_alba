  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Row(children: [
          Expanded(child: _TarjetaMetrica(titulo: 'Latencia', valor: '24 ms', icono: Icons.speed,       color: cs.primaryContainer)),
          const SizedBox(width: 8),
          Expanded(child: _TarjetaMetrica(titulo: 'CPU',      valor: '45%',   icono: Icons.memory,      color: cs.tertiaryContainer)),
        ]),
      ],
    );
  }
