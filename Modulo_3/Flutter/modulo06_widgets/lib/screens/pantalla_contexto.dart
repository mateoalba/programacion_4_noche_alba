        ...
        children: [
          _Seccion(
            ...
            items: [
              ...
              'Padding top:  ${paddingTop.toStringAsFixed(0)} px',
            ],
          ),
          ...
          Wrap(
            ...
            children: [
              ...
              _ChipColor(nombre: 'secondaryContainer', color: colores.secondaryContainer),
          ...
          FilledButton.icon(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('BuildContext permite acceder al árbol de widgets'),
                  behavior: SnackBarBehavior.floating,
                ),
              );
            },
            icon: const Icon(Icons.info, size: 18),
            label: const Text('Mostrar SnackBar (context)'),
          ),
        ],
      ),
    );
